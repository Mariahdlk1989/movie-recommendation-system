...
def create_user_item_matrix(train):
    ...
    values = train["rating"].astype(np.float32).to_numpy()
...
def calculate_popularity(train, movies):
...
def collaborative_scores(
    ...
    # IMPORTANT:
    # This creates only a vector of size
    # number_of_movies, NOT a huge
    # user x movie matrix.
...
def main():
    ...
    print("=" * 60)
    print("HYBRID MOVIE RECOMMENDATION SYSTEM V4")
    print("=" * 60)
    ...
    print("\n")
    print("=" * 60)
    print("HYBRID V4 RECOMMENDATIONS")
    print("=" * 60)
